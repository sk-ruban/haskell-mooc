...
oddFactorial 1 = 1
oddFactorial x = case odd x of
    True  -> x * oddFactorial (x - 2)
    False -> oddFactorial (x - 1)
...
countdown n = "Ready! " ++ countdownNum (n)

countdownNum :: Integer -> String
countdownNum 0 = "Liftoff!"
countdownNum x = show x ++ "... " ++ countdownNum(x - 1)
